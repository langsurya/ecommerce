          ...
          <div class="box-body">
            <div class="nav-tabs-custom">
              <ul class="nav nav-tabs">
                <li class="active"><a href="#semua" data-toggle="tab" aria-expanded="false">Semua <span class="badge">{{ $semua }}</span></a></li>
                <li class=""><a href="#blmbayar" data-toggle="tab" aria-expanded="false">Belum Bayar <span class="badge">{{ $belum }}</span></a></li>
                <li><a href="#finance" data-toggle="tab" aria-expanded="true">Diperiksa Finance <span class="badge">{{ $finance }}</span></a></li>
                <li><a href="#dikemas" data-toggle="tab" aria-expanded="true">Belum Dikemas <span class="badge">{{ $packing }}</span></a></li>
